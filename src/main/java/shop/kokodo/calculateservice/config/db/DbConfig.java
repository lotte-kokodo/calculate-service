package shop.kokodo.calculateservice.config.db;
...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        return entityManagerFactoryBuilder.dataSource(dataSource()).packages("shop.kokodo.calculateservice").build();
    }
    ...
    @Bean
    public PlatformTransactionManager crqsTransactionManager(EntityManagerFactory entityManagerFactory) {
